report 33019909 "TDS cert retire probation emp"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/6.Report/Rep33019909.TDScertRetireProbationemp.rdl';
    Caption = 'TDS certificate of retired employee under probation';
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            column(ResignationDate; Format(Employee."Resignation Date")) { }
            column(FunctionalTitle; Employee."Functional Title") { }
