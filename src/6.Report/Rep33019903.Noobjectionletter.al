report 33019903 "No objection letter"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/6.Report/Rep33019903.NoObjectionLetter.rdl';
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            column(HomeLoan; HomeLoan) { }
            column(VehicleLoan; VehicleLoan) { }
            column(OverDraftLoan; OverDraftLoan) { }
            ...
            begin
                ...
                LoanOutstandingfromFinacle.SetFilter("Loan Type", '%1|%2', LoanOutstandingfromFinacle."Loan Type"::"Home Loan", LoanOutstandingfromFinacle."Loan Type"::"Home Loan Insurance Tieup");
                LoanOutstandingfromFinacle.CalcSums("Outstanding Amount");
                HomeLoan := LoanOutstandingfromFinacle."Outstanding Amount";

                LoanOutstandingfromFinacle.Reset;
                LoanOutstandingfromFinacle.SetRange("Employee No.", Employee."No.");
                LoanOutstandingfromFinacle.SetRange("Loan Type", LoanOutstandingfromFinacle."Loan Type"::"Vehicle Loan");
                LoanOutstandingfromFinacle.CalcSums("Outstanding Amount");
                VehicleLoan := LoanOutstandingfromFinacle."Outstanding Amount";

                LoanOutstandingfromFinacle.Reset;
                LoanOutstandingfromFinacle.SetRange("Employee No.", Employee."No.");
                LoanOutstandingfromFinacle.SetRange("Loan Type", LoanOutstandingfromFinacle."Loan Type"::"Personal Loan");
                LoanOutstandingfromFinacle.CalcSums("Outstanding Amount");
                OverDraftLoan := LoanOutstandingfromFinacle."Outstanding Amount";
            end;
        }
    }
