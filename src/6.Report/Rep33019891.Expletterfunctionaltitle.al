report 33019891 "Exp letter functional title"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/6.Report/Rep33019891.Expletterfunctionaltitle.rdl';
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            column(FunctionalTitle_Employee; FTitle) { }
            ...
            begin
                ...
                FunctionalTitle.SetRange(Code, Employee."Functional Title");
                if FunctionalTitle.FindFirst then
                    FTitle := FunctionalTitle.Description;
            end;
        }
    }
    ...
    begin
        if referenceNo = '' then
            Error('Please enter refernece no.');
    end;
