report 33019890 "Experience letter (Regular)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/6.Report/Rep33019890.ExperienceletterRegular.rdl';
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            dataitem(Employee; Employee)
            {
                ...
                begin
                    ...
                    //ERROR('Please Select respective employee type');
                end;
            }
        }
    }
    ...
    begin
        if ReferenceNo = '' then
            Error('Please enter reference no.');
    end;
