codeunit 50002 "Loan Mgt."
{
    ...
    begin
        ...
        if ApproveBool then begin
            AllowanceAssignment.Validate("Approval Status", AllowanceAssignment."Approval Status"::"Pending Approval");
    ...
    procedure ApproveRejectAllowanceAssignment(Approved: Boolean; EntryNo: Integer)
    var
    ...
    begin
        ...
        EmpAllowance.TestField("Approval Status", EmpAllowance."Approval Status"::"Pending Approval");
    ...
    procedure ApproveRejectAllowanceAssignmentAPI(Approved: Boolean; EntryNo: Integer; EmpNo: Code[20])
    var
        EmpAllowance: Record "Allowance Assignment Header";
        PGSetup: Record "Payroll General Setup";
        EmpRec: Record Employee;
    ...
    procedure ReturnAllowanceAssignment(EntryNo: Integer)
    var
        EmpAllowance: Record "Allowance Assignment Header";
        PGSetup: Record "Payroll General Setup";
        EmpRec: Record Employee;
    ...
    procedure CheckEmployeeAlreadyExistsforSameEmployee(EntryNo: Integer; LineNo: Integer; EmpNo: Code[20]; Allowancetype: Code[20]; FromDate: Date)
    var
        AllowanceAssignmentLine: Record "Allowance Assignment Line";
    begin
        AllowanceAssignmentLine.Reset;
        AllowanceAssignmentLine.SetRange("Entry No.", EntryNo);
        ...
        if Screen then begin
            ...
            if AllowanceAssignmentLine.FindFirst then begin
                repeat
                    ...
                    if AllowanceHeader.Get(AllowanceAssignmentLine."Entry No.") and
    ...
    begin
        ...
        AllowanceAssignLine.SetRange("Entry No.", AllowanceAssignmentLine."Entry No.");
    ...
    begin
        ...
        if ReportSelections.FindFirst then begin
            repeat
                ...
                CreateNewDir(HRSetup."Attachment Storage Location", EmployeeLoanAdvance."Employee Code", DirectoryName);
