codeunit 33019802 "HR Mgt."
{
    ...
    begin
        ...
        if PromotionPageBuilder.RunModal then begin
            ...
            ServiceHistoryCode := AddToServiceHistory(EmpNo, ServiceHistory."Service Event"::"Internal Appointment", 'Promoted', PromotedDate);
        ...
        if Approve then begin
            ...
            if EmpAct."Approval Status" = EmpAct."Approval Status"::"Pending Approval" then begin
                ...
                if EmpAct."Approver Code" <> employeeNo then
                    Error('Your are not eligible to approve this document.');
                EmpAct.Validate("Approval Status", EmpAct."Approval Status"::Approved);
                AddToServiceHistory(EmpAct."Employee No.", ServiceHistory."Service Event"::Resignation, EmpAct.Remarks, EmpAct."HR Proposed Date");
