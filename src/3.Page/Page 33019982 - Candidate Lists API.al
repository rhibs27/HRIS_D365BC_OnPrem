page 33019982 "Candidate Lists API"
{
    ...
    layout
    {
        area(Content)
        {
            group(Group)
            {
                ...
                field(InterviewBy; Rec."Interview By") { }
                part(Control9; "Interview Evaluation Entries")
                {
                    EntityName = 'interviewEvaluationEntry';
                    EntitySetName = 'interviewEvaluationEntries';
