page 33020087 "KPI Appriasal Prev. Quarter"
{
    // version KPI1.00

    EntityName = 'kpiappprevquarter';
    EntitySetName = 'kpiappprevquarters';
    PageType = API;
    APIVersion = 'v2.0';
    DelayedInsert = true;
    APIGroup = 'HRMS';
    ...
    layout
    {
        area(Content)
        {
            ...
            part("KPI Appraisal Prev. Qr Line"; "KPI Appraisal Prev. Qr Line")
            {
                EntityName = 'kpiappprevquarterline';
                EntitySetName = 'kpiappprevquarterLines';
