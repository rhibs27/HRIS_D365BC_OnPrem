table 33019802 "KPI Master (NIC)"
{
    ...
    begin
        ...
        //     HRSetups.Get();
        //     HRSetups.TestField("KPI No. Series");
        //     "No. Series" := HRSetups."KPI No. Series";
        //     if NoSeries.AreRelated(HRSetups."KPI No. Series", xRec."No. Series") then
        //         "No. Series" := xRec."No. Series";
        //     "KPI No." := NoSeries.GetNextNo("No. Series");
        // end;
    end;
