table 50033 "Payroll Column Configuration"
{
    // version PRM19.01.01
    ...
    procedure FillFieldIDArray(var FieldIDArray: array[2, 120] of Integer; TableID: Integer; FieldQty: Integer; StartNumber: Integer; FieldStep: Integer)
    var
        i: Integer;
    begin
